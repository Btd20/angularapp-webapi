...
namespace UsersAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly SignInManager<UsersAPIUser> _signInManager;
        private readonly IConfiguration _configuration;

        public AuthController(UserManager<UsersAPIUser> userManager, SignInManager<UsersAPIUser> signInManager, IConfiguration configuration)
        {
        ...
        private async Task<string> GenerateJwtToken(UsersAPIUser user)
        {
            ...
            var claims = new List<Claim>
    {
        ...
        // Agrega más claims según tus necesidades
            ...
            var tokenOptions = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.UtcNow.AddMinutes(15), // Token válido por 1 hora
            ...
            await _userManager.SetAuthenticationTokenAsync(user, "usersapi", "acmetoken", tokenString);
